...
#     distancefn = get_ap_distancefn()
    ...
    ga = PDGA(pop_size=200, mut_rate=0.5, gen_gap=0.5, query=query_smiles, sim_treshold=0.6, 
              porpouse="cyclic", folder=f"{query_name}_{seed}", fingerprintfn=fingerprintfn, distancefn=distancefn, query_name=query_name, is_peptide_sequence=False, methyl=True, verbose=True, seed=seed)
